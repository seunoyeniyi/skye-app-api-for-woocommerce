...
add_action("admin_menu", function () {
    ...
    if (SKYE_ALLOW_API_TOKEN_KEY) add_submenu_page("skye-app", "Secure TOKEN KEY", "Secure TOKEN KEY", "manage_options", "skye-app-token-key", function() { include(plugin_dir_path(__FILE__) . 'pages/token-key-page.php'); }, 11);
